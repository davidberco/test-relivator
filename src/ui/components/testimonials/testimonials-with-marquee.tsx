    ...
    >
      <div className="mx-auto flex max-w-container flex-col items-center gap-4 text-center sm:gap-16">
        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 hidden w-1/12 bg-gradient-to-r from-background sm:block" />
          <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-1/12 bg-gradient-to-l from-background sm:block" />
        </div>
      </div>
    </section>
  );
